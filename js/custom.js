...
jQuery(document).ready(function(){
  ...
  if( $map.length ) {
    $map.gMap({
      address: '16875 West Bernardo Drive Suite 110, San Diego CA 92127',
      zoom: 16,
      markers: [ { 'address' : '16875 West Bernardo Drive Suite 110, San Diego CA 92127' } ]
    });
  }
  ...
  if( $map2.length ) {
    $map2.gMap({
      address: '18 Dr. Amilcar Cabral Road, Airport, Accra, Ghana ',
      zoom: 16,
      markers: [ { 'address' : '18 Dr. Amilcar Cabral Road, Airport, Accra, Ghana ' } ]
    });
  }
